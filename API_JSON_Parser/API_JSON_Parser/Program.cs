...
namespace API_JSON_Parser

{
   public class JSON
    {
        static string BingMapsKey = "vxl5KJvBTCGwnj4CRERT~z8Fd3ewBGLQ79v5UNeAkHg~AjQst9jHU44G78C5lXWfzElUaPtF4wjBxIJ_TcWu98xbfUA4MoK1SmUi_BI8MEzY";
        static void Main(string[] args)
        {
            try
            {
                string locationsRequest = CreateRequest("Macon");
